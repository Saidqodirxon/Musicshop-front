  ...
  return (
    <section className="py-12 sm:py-16 bg-[#ECDFD2]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1400px]">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#3D3D3D] mb-8 sm:mb-12 leading-tight">
          {lang === "ru"
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
          <div className="order-2 md:order-1">
            <h3 className="text-base sm:text-lg font-semibold text-[#666666] mb-4 sm:mb-6">
              {lang === "ru"
