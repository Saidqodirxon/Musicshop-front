...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#D0B298]" data-aos="fade-up" data-aos-delay="10">
      <div
      ...
      >
        <div className="flex flex-col md:flex-row justify-between gap-8 sm:gap-10 lg:gap-12 mb-10 sm:mb-12 lg:mb-16">
          ...
          {/* Navigation Links */}
          <div className="flex-shrink-0">
            <h3 className="text-[15px] sm:text-[16px] font-semibold text-[#2E2E2E] mb-4 sm:mb-5">
              {lang === "ru"
                ? "Главная"
                : lang === "uz"
                  ? "Bosh sahifa"
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link
                  to="/products"
                  className="text-[14px] sm:text-[15px] text-[#2E2E2E] hover:text-[#616060] transition-colors touch-manipulation"
                >
                  {lang === "ru"
                    ? "Каталог"
                    : lang === "uz"
          ...
          <div className="flex-shrink-0">
            ...
            <ul className="space-y-3 sm:space-y-4">
              {contacts?.phones && contacts.phones.length > 0 ? (
                contacts.phones.slice(0, 3).map((phone, index) => (
                  <li key={index} className="flex items-center gap-2 sm:gap-3">
                    <Phone className="w-4 h-4 sm:w-[18px] sm:h-[18px] text-[#2E2E2E] flex-shrink-0" />
                    <a
              ...
              {contacts?.telegram && (
                <li className="flex items-center gap-2 sm:gap-3">
                  <Send className="w-4 h-4 sm:w-[18px] sm:h-[18px] text-[#2E2E2E] flex-shrink-0" />
                  <a
                    href={
          ...
          <div className="flex-shrink-0 max-w-full md:max-w-[220px]">
            ...
            <p className="text-[14px] sm:text-[15px] text-[#2E2E2E] leading-[1.7]">
